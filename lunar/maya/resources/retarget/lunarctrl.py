...
templateLC = {
	...
	"tPose": {
		...
		'arm_pv_l_ctrl': {
			...
			# 								'spaceUseTranslate': True,
											'translateX': 3.219796676617996,
											'translateY': 0.8343382628834348,
											'translateZ': 39.59074374076485},
		'arm_pv_r_ctrl': {
			# 'space': 1,
			# 								'spaceUseRotate': False,
			# 								'spaceUseTranslate': True,
											'translateX': -3.219683468633022,
											'translateY': 0.83433558244257,
											'translateZ': 39.5903623234626},
		...
		'leg_pv_l_ctrl': {
			...
			# 								'spaceUseRotate': False,
			# 								'spaceUseTranslate': True,
											'translateX': -15.045296434817,
											'translateY': -0.7770731661457546,
											'translateZ': 1.3420414578820967},
		'leg_pv_r_ctrl': {
			# 'space': 2,
			# 								'spaceUseRotate': False,
			# 								'spaceUseTranslate': True,
											'translateX': 15.045292411002714,
											'translateY': -0.7770912415531654,
											'translateZ': 1.3414449563803146},
