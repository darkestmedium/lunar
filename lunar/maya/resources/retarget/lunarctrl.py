...
templateLC = {
	...
	"tPose": {
		...
		'arm_switch_l_ctrl': {'fist': 50.0,
													'fkIk': 0.0,
													'softness': 0.0,
													'spread': 50.0,
													# 'twist': 0.0
													},
		'arm_switch_r_ctrl': {'fist': 50.0,
													'fkIk': 0.0,
													'softness': 0.0,
													'spread': 50.0,
													# 'twist': 0.0
		...
		'hand_l_ctrl': {'rotateX': -22.226248125140277,
										'rotateY': 1.1541069831433228,
										'rotateZ': -2.0632733712145237},
		'hand_r_ctrl': {'rotateX': -22.226248125159973,
      ...
      # 'twist': 0.0
		...
		'leg_ik_r_ctrl': {'rotateX': -8.51237889324122,
											'rotateY': -0.2947558427344839,
											'rotateZ': -0.16962262334627695,
											# 'space': 2,
											# 'spaceUseRotate': True,
											# 'spaceUseTranslate': True,
											'translateX': 0.20002569410192983,
											'translateY': 1.287682294321749,
		...
		'leg_switch_l_ctrl': {'fkIk': 0.0, 'softness': 0.0, 
			# 'twist': 0.0
		},
		'leg_switch_r_ctrl': {'fkIk': 0.0, 'softness': 0.0, 
			# 'twist': 0.0
		},
		...
		'pinky_02_l_ctrl': {'rotateZ': -21.28699904924387},
		...
		'upperarm_l_ctrl': {'rotateX': 1.7268422965461196,
	...
	"aPose": {
		...
		'head_ik_ctrl': {'rotateX': 3.015203154493355e-11,
											...
											'translateZ': 0.0},
		'head_switch_ctrl': {'fkIk': 0.0, 'softness': 0.0, 
      # 'twist': 0.0
    },
